...
**Unix**: Sistema operacional original (proprietário)
**GNU**: Conjunto de ferramentas livres compatíveis com Unix
**Linux**: Kernel de código aberto
**GNU/Linux**: Sistema completo (GNU + Linux kernel)
...
- [Kernel.org](https://www.kernel.org/) - Site oficial do kernel Linux
- [GNU.org](https://www.gnu.org/) - Projeto GNU
- [Linux Foundation](https://www.linuxfoundation.org/) - Fundação Linux
...
**Próximo capítulo**: [2 - Instalação](https://www.nerdseverino.com.br/2023/05/09/2-instala%C3%A7%C3%A3o/)
